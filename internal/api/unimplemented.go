...
func (Unimplemented) GetTenantWallet(ctx context.Context, request gen.GetTenantWalletRequestObject) (gen.GetTenantWalletResponseObject, error) {
	return nil, errNotImplemented("GetTenantWallet")
}
